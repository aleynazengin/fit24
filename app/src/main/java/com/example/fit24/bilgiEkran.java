 ...
 */
public class bilgiEkran extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bilgi_ekran, container, false);
        spinner1=view.findViewById(R.id.spinner);
        spinner2=view.findViewById(R.id.spinner2);
        devam=view.findViewById(R.id.buttondevam2);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        devam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_bilgiEkran_to_spordereceEkran);
            }
        });
    }
}
